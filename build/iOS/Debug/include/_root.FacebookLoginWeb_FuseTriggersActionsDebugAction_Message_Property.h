...
namespace g{struct FacebookLoginWeb_FuseTriggersActionsDebugAction_Message_Property;}
...
struct FacebookLoginWeb_FuseTriggersActionsDebugAction_Message_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Triggers::Actions::DebugAction*> _obj;

    void ctor_2(::g::Fuse::Triggers::Actions::DebugAction* obj, ::g::Uno::UX::Selector name);
    static FacebookLoginWeb_FuseTriggersActionsDebugAction_Message_Property* New1(::g::Fuse::Triggers::Actions::DebugAction* obj, ::g::Uno::UX::Selector name);
};
// }
