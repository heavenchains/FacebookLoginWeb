...
{
    ::TYPES[20] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Bool_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
...
void Swiped__OnRooted_fn(Swiped* __this)
{
    ...
    uPtr(__this->_region)->add_Swiped(uDelegate::New(::TYPES[20/*Uno.Action<bool>*/], (void*)Swiped__OnSwiped_fn, __this));
}
...
{
    uPtr(__this->_region)->remove_Swiped(uDelegate::New(::TYPES[20/*Uno.Action<bool>*/], (void*)Swiped__OnSwiped_fn, __this));
    ::g::Fuse::Triggers::Trigger__OnUnrooted_fn(__this);
}
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("/Users/mostafa/Library/Application Support/Fusetools/Packages/Fuse.Gestures/0.42.4/$.uno");
...
void SwipeGesture__OnRooted_fn(SwipeGesture* __this)
{
    ...
    if (element == NULL)
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[3/*"Element"*/], __this->Parent(), __this, ::STRINGS[4/*"/Users/most...*/], 970, ::STRINGS[5/*"OnRooted"*/]);
        return;
    }
