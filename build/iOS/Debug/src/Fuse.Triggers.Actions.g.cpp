...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/Users/mostafa/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/0.42.4/$.uno");
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[5/*"no UserEven...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->EventName())), __this, ::STRINGS[6/*"/Users/most...*/], 240, ::STRINGS[7/*"Perform"*/]);
    else
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/Users/mostafa/Library/Application Support/Fusetools/Packages/Fuse.Controls.Navigation/0.42.4/$.uno");
    ::STRINGS[7] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[8/*"Requires a ...*/], __this, ::STRINGS[9/*"/Users/most...*/], 285, ::STRINGS[7/*"Perform"*/]);
        return;
    }
