...
{
    FuseControlsNative_bundle::iOSBlitter0a63f4bb_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[26/*"uniform vec...*/], ::STRINGS[27/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[4/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[3/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[7/*"f"*/]));
}
...
{
    FuseReactive_bundle::es6promisemindcd92cac_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[139/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[140/*"es6-promise...*/]);
    FuseReactive_bundle::Observabled73eeeb6_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[139/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[141/*"observable-...*/]);
    FuseReactive_bundle::setTimeout9c121c74_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[139/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[142/*"settimeout-...*/]);
}
...
static void FuseReactive_bundle_build(uType* type)
{
    ...
    ::STRINGS[141] = uString::Const("observable-66183501.js");
    ::STRINGS[142] = uString::Const("settimeout-cb0e3491.js");
    type->SetFields(0,
