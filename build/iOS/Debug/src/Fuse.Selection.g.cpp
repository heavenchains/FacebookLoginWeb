...
void Selection__FuseScriptingIObserverOnInsertAt_fn(Selection* __this, int* index, uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[21/*"removing in...*/], __this, ::STRINGS[5/*"/Users/most...*/], 880, ::STRINGS[22/*"Fuse.Script...*/]);
        return;
    }
...
void Selection__FuseScriptingIObserverOnNewAt_fn(Selection* __this, int* index, uObject* newValue)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[21/*"removing in...*/], __this, ::STRINGS[5/*"/Users/most...*/], 845, ::STRINGS[23/*"Fuse.Script...*/]);
        return;
    }
...
void Selection__FuseScriptingIObserverOnRemoveAt_fn(Selection* __this, int* index)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[21/*"removing in...*/], __this, ::STRINGS[5/*"/Users/most...*/], 869, ::STRINGS[24/*"Fuse.Script...*/]);
        return;
    }
...
void Selection::MaxCount(int value)
{
    ...
    if (value < 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[27/*"MaxCount mu...*/], this, ::STRINGS[5/*"/Users/most...*/], 553, ::STRINGS[28/*"set_MaxCount"*/]);
        return;
    }
...
void Selection::remove(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[25/*"remove requ...*/], s, ::STRINGS[5/*"/Users/most...*/], 360, ::STRINGS[2/*"remove"*/]);
        return;
    }
...
void Selection::toggle(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[26/*"toggle requ...*/], s, ::STRINGS[5/*"/Users/most...*/], 404, ::STRINGS[3/*"toggle"*/]);
        return;
    }
...
void ToggleSelection__Perform_fn(ToggleSelection* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[29/*"Unable to l...*/], __this, ::STRINGS[5/*"/Users/most...*/], 953, ::STRINGS[30/*"Perform"*/]);
        return;
    }
