...
double Marshal::ToDouble(uObject* o)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::STRINGS[52/*"Expected nu...*/], ::g::Uno::Object::GetType(uPtr(o))), 1, ::STRINGS[7/*"/Users/most...*/], 1024);
        return 0.0;
    }
}
...
static void NativeEvent_build(uType* type)
{
    ...
    ::STRINGS[70] = uString::Const("/Users/mostafa/Library/Application Support/Fusetools/Packages/Fuse.Scripting/0.42.4/$.uno");
...
{
    ::g::Uno::Diagnostics::Debug::Assert(Context() != NULL, ::STRINGS[69/*"this.Contex...*/], ::STRINGS[70/*"/Users/most...*/], 1023, uArray::New(::TYPES[5/*object[]*/], 0));
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[104/*"JavaScript ...*/], path), ::STRINGS[105/*" was fixed!"*/]), this, ::STRINGS[70/*"/Users/most...*/], 204, ::STRINGS[106/*"Require"*/]);
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[115/*"Cannot call...*/], __this, ::STRINGS[7/*"/Users/most...*/], 2182, ::STRINGS[116/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[130/*"Unexpected ...*/], this, ::STRINGS[7/*"/Users/most...*/], 1505, ::STRINGS[131/*"SetExclusive"*/]);
        return;
    }
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[67/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[133/*"Failed to s...*/], ex, this, ::STRINGS[7/*"/Users/most...*/], 1517, ::STRINGS[131/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
