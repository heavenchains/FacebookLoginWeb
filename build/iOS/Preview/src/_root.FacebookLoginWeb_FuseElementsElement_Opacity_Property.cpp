...
{
    uStackFrame __("FacebookLoginWeb_FuseElementsElement_Opacity_Property", "Get()");
...
{
    uStackFrame __("FacebookLoginWeb_FuseElementsElement_Opacity_Property", "Set(float,Uno.UX.IPropertyListener)");
    float v_ = *v;
