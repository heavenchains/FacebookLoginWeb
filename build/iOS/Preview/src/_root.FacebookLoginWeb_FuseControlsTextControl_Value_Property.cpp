...
{
    uStackFrame __("FacebookLoginWeb_FuseControlsTextControl_Value_Property", "Get()");
...
{
    uStackFrame __("FacebookLoginWeb_FuseControlsTextControl_Value_Property", "Set(string,Uno.UX.IPropertyListener)");
