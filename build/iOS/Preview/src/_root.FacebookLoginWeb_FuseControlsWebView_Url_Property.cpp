...
{
    uStackFrame __("FacebookLoginWeb_FuseControlsWebView_Url_Property", "Get()");
...
{
    uStackFrame __("FacebookLoginWeb_FuseControlsWebView_Url_Property", "Set(string,Uno.UX.IPropertyListener)");
